  ...
  return (
    <div className="jomp-landing min-h-screen bg-white text-[#111111]">
      ...
      <header className="relative overflow-hidden bg-[#01224F] pb-[120px] pt-[100px]">
        <span className="pointer-events-none absolute right-[8%] top-[78px] hidden h-[118px] w-[118px] rotate-[8deg] rounded-[30px] bg-gradient-to-br from-[#ee1a63] to-[#ff4d8d] shadow-[0_30px_60px_-20px_rgba(238,26,99,0.45)] md:block" />
        <span className="pointer-events-none absolute right-[2%] top-[230px] hidden h-[34px] w-[34px] rounded-full bg-[#c81361] md:block" />
        <div className="relative z-10 mx-auto max-w-[1120px] px-7">
          ...
          <div className="mt-16 flex flex-wrap gap-12">
            <div>
              <strong className="block text-[26px] font-bold text-white">12k+</strong>
              <span className="text-[13.5px] text-white/70">Verified applicants</span>
            </div>
            <div>
              <strong className="block text-[26px] font-bold text-white">3.4k+</strong>
              <span className="text-[13.5px] text-white/70">Employers hiring</span>
            </div>
            <div>
              <strong className="block text-[26px] font-bold text-white">98%</strong>
              <span className="text-[13.5px] text-white/70">Jobs completed on time</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <section id="employers" className="bg-white py-24">
        <div className="mx-auto grid max-w-[1120px] grid-cols-1 items-center gap-14 px-7 lg:grid-cols-2">
          <div className="reveal">
            ...
            <p className="mt-5 max-w-[480px] text-[16.5px] leading-relaxed text-[#111111]/70">
              Post a role once and reach a pool of applicants who&apos;ve already proven themselves — vetted profiles, real work history, and ratings from other employers.
            </p>
            <div className="mt-8 flex flex-col gap-5">
              {[
                ["01", "Vetted, ranked talent", "Every applicant profile carries a track record you can check before you hire."],
                ["02", "Post once, reach thousands", "Your listing goes straight to applicants actively looking for that exact skill set."],
                ["03", "Free hiring tools", "Screening, messaging, and job tracking — all built in, backed by JOMP's expertise."],
              ].map(([n, title, body]) => (
                <div key={n} className="flex gap-3.5">
                  <div className="flex h-[38px] w-[38px] shrink-0 items-center justify-center rounded-[11px] bg-[#01224F] text-[14px] font-bold text-[#2fd8d0]">{n}</div>
                  <div>
          ...
          <div className="reveal relative min-h-[380px] overflow-hidden rounded-[28px] bg-[#01224F] p-8 text-white">
            ...
            {[
              { name: "Product Designer", meta: "4.9 rating · 62 jobs done", rate: "$45/hr", bg: "linear-gradient(135deg,#2fd8d0,#1aa9a2)" },
              { name: "Backend Engineer", meta: "5.0 rating · 40 jobs done", rate: "$60/hr", bg: "linear-gradient(135deg,#ee1a63,#ff4d8d)" },
              { name: "Content Strategist", meta: "4.8 rating · 88 jobs done", rate: "$32/hr", bg: "linear-gradient(135deg,#f2871f,#ffb35c)" },
            ].map((card) => (
              <div key={card.name} className="mb-3.5 flex items-center gap-3.5 rounded-2xl border border-white/10 bg-[#163056] px-5 py-4">
                ...
                <div className="ml-auto text-[13.5px] font-bold text-[#2fd8d0]">{card.rate}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="connection" className="relative overflow-hidden bg-[#01224F] py-28 text-center text-white">
        <div className="relative z-10 mx-auto max-w-[1120px] px-7">
          ...
          <p className="reveal mx-auto mt-5 max-w-[560px] text-[16.5px] leading-relaxed text-white/70">
            No hidden gatekeeping and no black-box algorithms deciding who gets seen. Applicants apply directly, employers respond directly, and every job stays visible on open ground.
          </p>

          <div className="reveal mt-16 flex flex-col items-center justify-center gap-0 sm:flex-row">
            <div className="w-[180px] rounded-[20px] border border-white/10 bg-[#163056] px-5 py-7">
              <div className="mx-auto mb-3.5 flex h-10 w-10 items-center justify-center rounded-xl bg-[#2fd8d0]/15 text-[16px] font-bold text-[#2fd8d0]">A</div>
              <h4 className="text-[15px] font-semibold text-white">Applicants</h4>
              <p className="mt-2 text-[12.5px] leading-relaxed text-white/60">Build a profile, browse open roles, apply directly to employers.</p>
            </div>
            <div className="flex h-[60px] w-[60px] items-center justify-center sm:h-auto sm:w-[120px]">
              <svg viewBox="0 0 120 40" fill="none" className="h-full w-full rotate-90 sm:rotate-0">
                <path d="M0,20 C30,0 90,40 120,20" stroke="#2fd8d0" strokeWidth="2.5" />
              </svg>
            </div>
            <div className="w-[180px] rounded-[20px] border border-white/10 bg-[#163056] px-5 py-7">
              <div className="mx-auto mb-3.5 flex h-10 w-10 items-center justify-center rounded-xl bg-[#f2871f]/15 text-[16px] font-bold text-[#f2871f]">E</div>
              <h4 className="text-[15px] font-semibold text-white">Employers</h4>
              <p className="mt-2 text-[12.5px] leading-relaxed text-white/60">Post roles, review applicants, message and hire without a middleman.</p>
            </div>
          </div>

          <div className="mt-16 grid grid-cols-1 gap-6 text-left md:grid-cols-3">
            {[
              ["TRANSPARENT", "Open job listings", "Every posting shows its scope, budget, and requirements up front — no surprise terms."],
              ...
              <div key={kicker} className="reveal rounded-[18px] border border-white/10 bg-white/5 p-6">
                <div className="text-[13px] font-bold tracking-[0.1em] text-[#2fd8d0]">{kicker}</div>
      ...
      <section id="stats" className="bg-white py-24">
        <div className="mx-auto max-w-[1120px] px-7">
          <div className="reveal max-w-[600px]">
            ...
            <p className="mt-4 text-[16px] leading-relaxed text-[#111111]/70">
          ...
          <div className="mt-10 grid grid-cols-1 items-stretch gap-7 lg:grid-cols-[0.85fr_1.15fr]">
            <div className="reveal rounded-[28px] bg-[#01224F] p-9 text-white">
              <span className="text-[13px] font-semibold uppercase tracking-[0.22em] text-[#2fd8d0]">Platform mix</span>
              <h3 className="mt-2.5 text-[20px] font-semibold text-white">Applicants vs Employers</h3>
              <div className="my-8 flex justify-center">
                <div
                  className="flex h-[190px] w-[190px] shrink-0 items-center justify-center rounded-full"
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2.5 text-[14px] text-[#dfe6f5]">
                  <span className="h-2.5 w-2.5 shrink-0 rounded-full bg-[#2fd8d0]" />
                  <span>Applicants</span>
                  <span className="ml-auto font-bold text-white">72%</span>
                </div>
                <div className="flex items-center gap-2.5 text-[14px] text-[#dfe6f5]">
                  <span className="h-2.5 w-2.5 shrink-0 rounded-full bg-[#ee1a63]" />
                  <span>Employers</span>
            ...
            <div className="reveal rounded-[28px] bg-[#01224F] p-9 text-white">
              ...
              <p className="mt-5 border-t border-white/10 pt-4 text-[13.5px] leading-relaxed text-white/60">
                By June, <strong className="text-[#2fd8d0]">44%</strong> of applicants on JOMP had been hired for at least one role.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="register" className="bg-[#f5f6fa] py-28">
        <div className="mx-auto max-w-[1120px] px-7">
          ...
          <div className="mt-14 grid grid-cols-1 gap-7 md:grid-cols-2">
            <div className="reveal rounded-[26px] border border-[#2fd8d0]/20 bg-[#01224F] p-10 text-white">
              <div className="mb-5 flex h-[52px] w-[52px] items-center justify-center rounded-[15px] bg-[#2fd8d0]/15 text-[20px] font-bold text-[#2fd8d0]">A</div>
              ...
              <ul className="mt-6 space-y-2.5 text-[13.5px] text-[#cfd7ea]">
                <li className="flex items-center gap-2.5"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#2fd8d0]" />Build a profile that shows your track record</li>
                <li className="flex items-center gap-2.5"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#2fd8d0]" />Apply directly to open roles, no bidding wars</li>
                <li className="flex items-center gap-2.5"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#2fd8d0]" />Get rated and build your reputation over time</li>
              </ul>
            ...
            <div className="reveal rounded-[26px] border border-[#ee1a63]/20 bg-[#2a1730] p-10 text-white">
              <div className="mb-5 flex h-[52px] w-[52px] items-center justify-center rounded-[15px] bg-[#ee1a63]/15 text-[20px] font-bold text-[#ee1a63]">E</div>
              <h3 className="text-[23px] font-bold">I&apos;m an employer</h3>
              <p className="mt-3 max-w-[340px] text-[14.5px] leading-relaxed text-white/70">Post a role and connect with applicants who are ready to get the job done.</p>
              <ul className="mt-6 space-y-2.5 text-[13.5px] text-[#cfd7ea]">
                <li className="flex items-center gap-2.5"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#ee1a63]" />Post jobs and reach vetted applicants fast</li>
                <li className="flex items-center gap-2.5"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#ee1a63]" />Review real work history before you hire</li>
                <li className="flex items-center gap-2.5"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#ee1a63]" />Manage hires with free built-in tools</li>
              </ul>
              <Link href="/signup?role=employer" className="mt-7 flex w-full items-center justify-center rounded-xl bg-[#ee1a63] py-3.5 text-[14.5px] font-semibold text-white">Register as an employer</Link>
            </div>
          </div>
        </div>
      </section>
